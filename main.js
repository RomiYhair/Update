...
if (reason == 405) {
await fs.unlinkSync("./SpiderBot/" + "creds.json")
...
let prekey = []
let directorio = readdirSync("./SpiderBot")
let filesFolderPreKeys = directorio.filter(file => {
return file.startsWith('pre-key-')
})
prekey = [...prekey, ...filesFolderPreKeys]
filesFolderPreKeys.forEach(files => {
unlinkSync(`./SpiderBot/${files}`)
})
} 
...
const directories = ['./SpiderBot/', './GataJadiBot/']
