...
lugar = official[0][0] == String(contact[0]) ? '🇵🇪 Peru' : official[1][0] == String(contact[0]) ? '🇵🇪 Peru' : official[2][0] == String(contact[0]) ? '🇵🇪 Peru' : official[3][0] == String(contact[0]) ? '🇵🇪 Peru' : country === '' ? lenguajeGB.smsContacto7() : country
enlace = official[0][0] == String(contact[0]) ? 'https://www.instagram.com/spider.ventas.bot' : official[1][0] == String(contact[0]) ? 'https://www.instagram.com/spider.ventas.bot' : official[2][0] == String(contact[0]) ? 'https://www.instagram.com/spider.ventas.bot' : official[3][0] == String(contact[0]) ? 'https://www.instagram.com/spider.ventas.bot' : md 
   
lista.push([number, ofc, nombre, description, official[3][0] == String(contact[0]) ? null : correo, lugar, enlace, bio, official[1][0] == String(contact[0]) ? 'https://www.instagram.com/spider.ventas.bot' : null]) }  
lista.push([conn.user.jid.split('@')[0], await conn.getName(conn.user.jid), packname, lenguajeGB.smsContacto8(), mail === '' ? 'centergataot@gmail.com' : mail, lenguajeGB.smsContacto7(), md, bioBot, yt, ig, fb, paypal, nna])
