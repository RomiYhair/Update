...
//let adReply = { fileLength: fsizedoc, seconds: fsizedoc, contextInfo: { forwardingScore: fsizedoc, externalAdReply: { showAdAttribution: true, title: wm, body: '👋 ' + username, mediaUrl: ig, description: 'Ey Hola', previewType: 'PHOTO', thumbnail: await(await fetch(gataMenu.getRandom())).buffer(), sourceUrl: redesMenu.getRandom() }}}
...
*╭━〔 FUNCIÓN COMPTA 〕━⬣*
┃ *Ya puedes comprar tú*
┃ *Bot Y Tus Diamantes!!*
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃🕷 _${usedPrefix}Yape | Mandar Comprobante_
┃🕷 _${usedPrefix}Vendedores | Oficiales_
┃🕷 _${usedPrefix}PrecipFull | Venta Del Bot Full_
┃🕷 _${usedPrefix}Pago2 | Compra Bot Con Diamante_
┃🕷 _${usedPrefix}Pago3 | Ventas De Diamantes_
*╰━━━━━━━━━━━━⬣*


*╭━〔 JUEGOS - MULTI JUEGOS 〕━⬣*
┃🕷➺ _${usedPrefix}Cumple | @tag_
┃🕷➺ _${usedPrefix}Nalga | @tag_
┃🕷➺ _${usedPrefix}Huevo | @tag_
┃🕷➺ _${usedPrefix}Abrazo | @tag_
┃🕷➺ _${usedPrefix}Cumple | @tag_
┃🕷➺ _${usedPrefix}Cuando | Txt_
┃🕷➺ _${usedPrefix}MiNovio | @tag_
┃🕷➺ _${usedPrefix}MiNovia | @tag_
┃🕷➺ _${usedPrefix}Formartrio_
┃🕷➺ _${usedPrefix}Zodiac | Txt_
┃🕷➺ _${usedPrefix}Sorteo | Txt_
┃🕷➺ _${usedPrefix}Violar | @tag_
┃🕷➺ _${usedPrefix}Sega_
┃🕷➺ _${usedPrefix}Ship2_
...
┃┈┈┈┈┈┈┈┈┈┈┈┈┈┈┈
┃🕷➺ _${usedPrefix}Comunidad | Invocar_
┃🕷➺ _${usedPrefix}Vs | Invocar_
┃🕷➺ _${usedPrefix}Sorteos | Invocar_
┃🕷➺ _${usedPrefix}Dinamicas | Invocar_
